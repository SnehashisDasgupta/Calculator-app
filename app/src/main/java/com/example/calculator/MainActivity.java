...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    MaterialButton buttonC, buttonAns;
    MaterialButton buttonMod, buttonAC,buttonDiv, buttonPlus, buttonMul, buttonMinus, buttonEquals;
    ...
    public void onClick(View view) {
        ...
        if(buttonText.equals("ANS")){
            ...
            dataToCalculate+=resultTv.getText();
        }
